...
export default function Contact() {
  return (
    <SectionWrapper id="contact" title="Get In Touch" index="06">
      <div className="max-w-2xl mx-auto text-center">
        <motion.p
          ...
          className="text-secondary text-lg leading-relaxed mb-10"
        >
        ...
        <motion.a
          ...
          className="inline-block px-10 py-4 border border-accent text-accent font-mono text-sm hover:bg-accent/10 transition-all rounded glow"
        >
          Say Hello
        </motion.a>
